...
void Controller__adacrus_step(int left_wl, int center_wl, int right_wl,
  ...
  switch (self->ck) {
    ...
    case Controller__St_Order:
      ...
      if (v_45) {
        v_47 = true;
        v_46 = Controller__St_Fwdimpulse;
      } else {
        v_47 = self->pnr;
        v_46 = Controller__St_Order;
      };
      v_42 = (comms==5);
      v_43 = (_out->nod&&v_42);
      if (v_43) {
        v_49 = true;
        v_48 = Controller__St_RSwi;
      } else {
        v_49 = v_47;
        v_48 = v_46;
      };
  ...
  switch (ck_1) {
    ...
    case Controller__St_LSwi:
      ...
      v_r_St_LSwi = 200;
      v_l_St_LSwi = -200;
      v_69 = (t_2==Controller__swiveltime);
      if (v_69) {
        nr_St_LSwi = true;
    ...
    case Controller__St_RSwi:
      ...
      v_r_St_RSwi = -200;
      v_l_St_RSwi = 200;
      v_64 = (t_3==Controller__swiveltime);
      if (v_64) {
        nr_St_RSwi = true;
